...
namespace HeimrichHannot\TwigTemplatesBootstrap4Bundle\ContaoManager;
...
class Plugin implements BundlePluginInterface, ConfigPluginInterface
{
    ...
    {
        $loader->load('@HeimrichHannotTwigTemplatesBootstrap4Bundle/Resources/config/services.yml');
    }
}
